...
namespace ConsoleApp
{
    static class Sorts
    {
        ...
        public static IEnumerable<TValue> InsertSort<TValue>(this IEnumerable<TValue> item) where TValue : IComparable<TValue>
        {
            int i, j;
        ...
        public static IEnumerable<TValue> InsertSortWithDelegate<TValue>(this IEnumerable<TValue> item, CompareDelegate<TValue> compareDelegate)
        {
            int i, j;
    ...
    class Program
    {
        ...
        {
            string[] a = { "dfd", "sss", "aaa", "bba", "baa", "bbb" };


            //var b = Sorts.QuickSortWithDelegate(a, (string item1, string item2) => string.Compare(item1, item2));
            //b = a.QuickSortWithDelegate((string item1, string item2) => string.Compare(item1, item2));
            //var b = a.BubbleSort();
            //var b = a.BubbleSortWithDelegate((string item1, string item2) => string.Compare(item1, item2));
            //var b = a.SelectionSort();
            //var b = a.SelectionSortWithDelegate((string item1, string item2) => string.Compare(item1, item2));
            //var b = a.InsertSort();
            //var b = a.InsertSortWithDelegate((string item1, string item2) => string.Compare(item1, item2));
            //var b = a.ShellSort();
            var b = a.ShellSortWithDelegate((string item1, string item2) => string.Compare(item1, item2));
